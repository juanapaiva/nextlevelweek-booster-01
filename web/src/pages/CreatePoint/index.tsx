...
/*
* Sempre que é criado um estado para um array ou objeto, é preciso, manualmente,
...
const CreatePoint = () => {
  ...
  const [selectedPosition, setSelectedPosiition] = useState<[number, number]>([0, 0]);
